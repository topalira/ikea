...
const Track = ({ data }) => {
  ...
  return (
    <div className="products__container">
      {showLeft && (
        <button className="products__arrow left" onClick={() => scroll("left")}>
      ...
      <button className="products__arrow right" onClick={() => scroll("right")}>
...
const Products = () => {
  return (
    <section className="products_categorie">
      ...
      <Track
        data={[
          { id: 1, image: "/path-to-img1.jpg", title: "СКАНДІ КУХНЯ" },
