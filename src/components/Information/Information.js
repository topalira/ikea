...
function Information() {
  return (
    <section className="inform">
      <h2 className="inform-title">ІНФОРМАЦІЯ</h2>

      <div className="inform-wrapper">
        <div className="inform-image">
          <img src="/information.jpg" alt="" className="inform-main-img" />
        </div>

        <div className="inform-card">
          <div className="inform-card-content">
